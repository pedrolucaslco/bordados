        ...
        {currentPage === 'dashboard' && (
          <div className="p-4">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <button onClick={() => handleNavigate('clients')} className="card bg-base-100 shadow-sm border border-base-200 hover:shadow-md transition-shadow">
                <div className="card-body items-center text-center p-6 gap-2">
                  <span className="text-4xl">👥</span>
                  <h3 className="card-title text-base mt-2">Clientes</h3>
                </div>
              </button>
              <button onClick={() => handleNavigate('products')} className="card bg-base-100 shadow-sm border border-base-200 hover:shadow-md transition-shadow">
                <div className="card-body items-center text-center p-6 gap-2">
                  <span className="text-4xl">🏷️</span>
                  <h3 className="card-title text-base mt-2">Produtos</h3>
                </div>
              </button>
            </div>
            <div className="text-center py-8">
              <p className="text-base-content/60 text-sm">Mais métricas em desenvolvimento...</p>
            </div>
          </div>
        )}
